-- 1. Remover Views dependentes temporariamente
DROP VIEW IF EXISTS vw_pedido_read_model;
DROP VIEW IF EXISTS vw_pedidodetalhado;

-- 2. Alterar tipo da coluna valortotal para suportar decimais
ALTER TABLE pedido ALTER COLUMN valortotal TYPE numeric(12,2);

-- 3. Função e Trigger para atualizar o total do pedido baseado nos itens
...
-- 4. Função e Trigger para sincronizar o pagamento com o total do pedido
